const ActividadReposoPreguntasArray = [
  ...
  {
    pregunta: "6. Levantar objetos desde alturas que están entre rodillas y pecho",
  ...
  {
    pregunta: "15. ¿Realiza movimientos con los brazos por encima o detrás de los hombros?",
  ...
  {
    pregunta: "17. ¿El trabajo incluye movimientos repetitivos de las manos o tiene que abrir excesivamente los dedos o torcerlos?",
  ...
  {
    pregunta: "20. Tiene que torcer o mantener tensa la o las muñecas para trabajar",
    preguntaInputName: "trabajoexigencia20",
    opciones: [{ valor: "Sí" }, { valor: "No" }],
  },
  {
    pregunta: "21. Realiza movimientos repetidos como para mover una manivela para atornillar o enroscar",
    preguntaInputName: "trabajoexigencia21",
    opciones: [{ valor: "Sí" }, { valor: "No" }],
  },
  {
    pregunta: "22. El peso del cuerpo recae solo en uno de los pies o en una pierna (sin posibilidad de descansar el pie en un escalón o periquera)",
    preguntaInputName: "trabajoexigencia22",
    opciones: [{ valor: "Sí" }, { valor: "No" }],
  },
  {
    pregunta: "23. Utiliza pedales u otros mecanismos con los pies o las rodillas.",
  ...
  {
    pregunta: "25. Los dispositivos o pedales son inestables o están mal colocados",
  ...
  {
    pregunta: "29. Al estar sentado, no es posible apoyar los pies en algún lado",
    preguntaInputName: "trabajoexigencia29",
    opciones: [{ valor: "Sí" }, { valor: "No" }],
  },
  {
    pregunta: "30. Para realizar su trabajo debe permanecer en cuclillas o arrodillado",
